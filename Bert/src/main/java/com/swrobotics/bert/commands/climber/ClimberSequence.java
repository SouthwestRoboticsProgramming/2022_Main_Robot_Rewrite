...
public final class ClimberSequence extends CommandSequence {
    ...
    public ClimberSequence(Climber climber, Input input, AHRS gyro) {
        ...
        append(new ClimberStep(climber, CLIMB_STEP_1_TELE, CLIMB_STEP_1_ROT, false)); // 1:Base
        append(new ClimberStep(climber, CLIMB_STEP_1_5_TELE, CLIMB_STEP_1_ROT, false)); // 1.5:Arms up
        append(new ClimberStep(climber, CLIMB_STEP_2_TELE, CLIMB_STEP_1_ROT, true)); // 2:Pull up
        append(new ClimberStep(climber, CLIMB_STEP_2_TELE, CLIMB_STEP_3_ROT, true)); // 3:Lock in
        append(new ClimberStep(climber, CLIMB_STEP_4_TELE, CLIMB_STEP_4_ROT, false)); // 4:Handoff
        append(new WaitForAngle(gyro, CLIMB_STEP_4_5_GYRO));
        append(new ClimberStep(climber, CLIMB_STEP_5_TELE, CLIMB_STEP_4_ROT, false)); // 5:Extend to 3
        append(new ClimberStep(climber, CLIMB_STEP_5_TELE, CLIMB_STEP_6_ROT, false)); // 6:Pressure on 3
        append(new ClimberStep(climber, CLIMB_STEP_2_TELE, CLIMB_STEP_1_ROT, true)); // 2:Pull Up
        append(new ClimberStep(climber, CLIMB_STEP_2_TELE, CLIMB_STEP_3_ROT, true)); // 3:Lock in
        append(new ClimberStep(climber, CLIMB_STEP_4_TELE, CLIMB_STEP_4_ROT, false)); // 4:Handoff
        append(new WaitForAngle(gyro, CLIMB_STEP_4_5_GYRO));
        ...
        append(new ClimberStep(climber, CLIMB_STEP_2_TELE, CLIMB_STEP_3_ROT, true)); // 3:Lock in
        append(new ClimberStep(climber, CLIMB_STEP_4_TELE, CLIMB_STEP_4_ROT, false)); // 4:Handoff
        append(new ClimberStep(climber, CLIMB_STEP_1_5_TELE, CLIMB_STEP_4_ROT, false)); // 1.5:Arms up
