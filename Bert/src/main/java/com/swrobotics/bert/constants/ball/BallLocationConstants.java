...
public final class BallLocationConstants {
    ...
    public static final BallLocation BLUE_1 = new BallLocation(-2.094, -3.231);
    public static final BallLocation BLUE_2 = new BallLocation(2.281, -3.106);
    public static final BallLocation BLUE_3 = new BallLocation(3.881, -0.569);
    public static final BallLocation BLUE_4 = new BallLocation(3.219, 2.369);
    public static final BallLocation BLUE_5 = new BallLocation(-0.844, 3.931);
    public static final BallLocation BLUE_6 = new BallLocation(-3.819, -0.718);
